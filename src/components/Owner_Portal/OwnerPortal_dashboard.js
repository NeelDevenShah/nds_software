...
import CmpDetail from './dashboard/cards/CmpDetail';
import UserOfCompany from './dashboard/cards/UserOfCompany'
import DeletedCmp from './dashboard/cards/DeletedCmp'
