...
function Sales_Activity() {
  ...
  return (
    <div className='container bg-white py-3' style={{ borderRadius: '5px' }}>
      <DeleteCategotyModal />
      <AddCategoryModal />
      <h2 className='pt-3'><strong>Stock Details According To Item Category</strong></h2>
      <div className='container'>
        <div className='row'>
          ...
          <div className={`col-md-4 my-4`}>
            <div class="card">
              <div class="card-body">
                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#AddCatModal"><img src={plus} width='55'></img></button>
              </div>
            </div>
          </div>
        </div>
