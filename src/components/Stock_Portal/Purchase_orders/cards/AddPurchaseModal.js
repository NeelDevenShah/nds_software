            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="mb-3">
                                <label class="form-label">Enter The Seller Company's Name</label>
                                ...
                                <label class="form-label">Enter Broker Name</label>
                                <input type="text" class="form-control text-center" id="comp" aria-describedby="emailHelp" name="compName" onChange={onChange} required />
                                ...
                                <label class="form-label">Enter Date Of Commited Order Dispatch From Seller</label>
                                <div class="payMe d-flex justify-content-center">
